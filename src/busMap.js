class busMap {
    ...
    drawMap(d3, zipData, busData, priceData) {
        ...
        let textOnDisplay = "Bus/Link Station Count";
        ...
        // let data = {"price":{"max":0}, "bus":{"max":0}};
        let data = {"price":{}, "bus":{}};
        ...
        para.innerHTML = "From the graph, we can see that the data points generally show a positive linear association. " +
            "There is an association between the number of bus stations and the housing prices, " +
            "as economically active areas and business districts tend to have better, busier transportation system.";
        ...
        function handleMouseOver() {
            ...
            var priceForZipcode = data["bus"][this.id];
        ...
        function handleMouseOut() {
            // Clean up old tooltips
            document.getElementById(theme + this.id + "dot").style.fill = color(data["bus"][this.id]);
        ...
        function mapFillFunct(d) {
            var zipObject = data["bus"][+d.properties.ZCTA5CE10];
            if (zipObject) {
